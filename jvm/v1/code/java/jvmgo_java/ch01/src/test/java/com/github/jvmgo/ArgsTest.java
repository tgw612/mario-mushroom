...
public class ArgsTest {
    ...
    public void test() {
        ...
        assertEquals("foo.jar", com.github.jvmgo.Args.parse(new String[]{"-classpath", "foo.jar"}).classpath);
        assertEquals(Arrays.asList("Main", "foo"), com.github.jvmgo.Args.parse(new String[]{"Main", "foo"}).mainClassAndArgs);
    }
