...
public class MathTest {
  ...
  private static int iadd(int a, int b) {
    return a + b;
  }

  private static int isub(int a, int b) {
    return a - b;
  }
  ...
  private static int idiv(int a, int b) {
    return a / b;
  }

  private static int irem(int a, int b) {
    return a % b;
  }

  private static int ineg(int a) {
    return -a;
  }

  private static int ishl(int a, int b) {
    return a << b;
  }

  private static int ishr(int a, int b) {
    return a >> b;
  }

  private static int iushr(int a, int b) {
    return a >>> b;
  }

  private static int iand(int a, int b) {
    return a & b;
  }

  private static int ior(int a, int b) {
    return a | b;
  }

  private static int ixor(int a, int b) {
    return a ^ b;
  }

  private static long ladd(long a, long b) {
    return a + b;
  }

  private static long lsub(long a, long b) {
    return a - b;
  }

  private static long lmul(long a, long b) {
    return a * b;
  }
  ...
  private static long lrem(long a, long b) {
    return a % b;
  }

  private static long lneg(long a) {
    return -a;
  }

  private static long lshl(long a, long b) {
    return a << b;
  }

  private static long lshr(long a, long b) {
    return a >> b;
  }

  private static long lushr(long a, long b) {
    return a >>> b;
  }

  private static long land(long a, long b) {
    return a & b;
  }

  private static long lor(long a, long b) {
    return a | b;
  }

  private static long lxor(long a, long b) {
    return a ^ b;
  }

  private static float fadd(float a, float b) {
    return a + b;
  }

  private static float fsub(float a, float b) {
    return a - b;
  }

  private static float fmul(float a, float b) {
    return a * b;
  }

  private static float fdiv(float a, float b) {
    return a / b;
  }
  ...
  private static float fneg(float a) {
    return -a;
  }

  private static double dadd(double a, double b) {
    return a + b;
  }

  private static double dsub(double a, double b) {
    return a - b;
  }

  private static double dmul(double a, double b) {
    return a * b;
  }
  ...
  private static double drem(double a, double b) {
    return a % b;
  }

  private static double dneg(double a) {
    return -a;
  }
