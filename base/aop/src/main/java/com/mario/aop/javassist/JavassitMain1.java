...
public class JavassitMain1 {
  ...
  public static void main(String[] args)
      throws NotFoundException, CannotCompileException, IOException, NoSuchMethodException, IllegalAccessException, InstantiationException, InvocationTargetException {
    ...
    Method method = o.getClass()
        .getMethod(" System.out.println(\"execute():\"+this.prop);", new Class[]{});
