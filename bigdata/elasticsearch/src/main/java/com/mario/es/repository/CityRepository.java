package com.mario.es.repository;

import com.mario.es.domain.City;
...
public interface CityRepository extends ElasticsearchRepository<City, Long> {
   ...
   * @param page
   * @return
   * @Query("{\"bool\" : {\"must\" : {\"term\" : {\"description\" : \"?0\"}}}}") Page<City>
   * findByDescription(String description, Pageable pageable);
   */
